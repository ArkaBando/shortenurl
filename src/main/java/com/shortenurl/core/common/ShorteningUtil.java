...
public class ShorteningUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println( urlEncoder.encode("https://github.com/wisehero/springboot-url-shortener/blob/main/src/main/java/prgms/marco/springbooturlshortener/entity/Url.java", Charset.defaultCharset()));
    }
